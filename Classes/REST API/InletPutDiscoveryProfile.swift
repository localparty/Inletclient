...
extension API {
    static func putDiscoveryProfile(channelSpecificConsumerId: String, consentId: String, zip: String, phoneCountryCode: String, phone: String, email:String) -> Endpoint<DiscoveryProfile> {
