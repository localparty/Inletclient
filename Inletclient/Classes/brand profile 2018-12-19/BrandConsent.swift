...
struct BrandConsent : Codable {
        ...
        enum CodingKeys: String, CodingKey {
                ...
                case consentLastAccessed = "consentLastAccessed"
        ...
        init(from decoder: Decoder) throws {
                ...
                consentLastAccessed = try values.decodeIfPresent(Int.self, forKey: .consentLastAccessed)
